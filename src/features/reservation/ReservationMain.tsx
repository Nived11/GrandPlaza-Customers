...
export default function ReservationMain({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#07130F]/70 p-2 backdrop-blur-[5px] sm:p-4"
      onMouseDown={(event) => {
        if (
    ...
    >
      <div
        ...
        className="relative max-h-[96dvh] w-full max-w-[95vw] overflow-y-auto overflow-x-hidden rounded-xl border border-white/50 bg-white shadow-[0_24px_80px_rgba(0,0,0,0.28)] sm:w-[90vw] sm:max-h-[90dvh] sm:rounded-2xl md:max-w-[640px] md:rounded-[22px] lg:w-[860px] lg:max-w-[92vw]"
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                maxLength={500}
                placeholder="Birthday celebration, preferred seating..."
