  ...
  return (
    ...
    <div className="relative w-full bg-[var(--brand-green-dark)] border border-[var(--brand-gold)]/40 rounded-xl overflow-hidden flex flex-col shadow-xl">
      ...
      <div className="absolute right-0 top-0 w-full h-full z-0">
        ...
        />
        {/* 🌟 THEME UPDATE: Reduced opacity green gradient for better image visibility */}
        <div className="absolute inset-0 bg-gradient-to-t from-[var(--brand-green-dark)]/95 via-[var(--brand-green-dark)]/50 to-transparent md:bg-gradient-to-r md:from-[var(--brand-green-dark)]/90 md:via-[var(--brand-green-dark)]/30 md:to-transparent"></div>
      </div>
      ...
      <div className="relative z-10 w-full bg-black/30 backdrop-blur-md border-t border-white/5 px-2 py-2 sm:px-4 md:px-6 md:py-4 lg:px-10 flex flex-row items-center justify-between gap-1 sm:gap-2 md:gap-4 lg:gap-8 overflow-hidden">

        {/* Feature 1 */}
        <div className="flex items-center gap-1.5 md:gap-3 w-[32%] md:w-auto">
          <div className="text-[var(--brand-gold)] bg-black/40 p-1.5 md:p-2 lg:p-2.5 rounded-lg md:rounded-xl border border-[var(--brand-gold)]/20 shrink-0">
          ...
          <div className="flex flex-col overflow-hidden">
            ...
            <p className="text-gray-300 text-[5px] sm:text-[6px] md:text-[9px] lg:text-[10px] mt-0.5 truncate">Hassle-free reservation</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 md:gap-3 w-[32%] md:w-auto">
          ...
          <div className="flex flex-col overflow-hidden">
            ...
            <p className="text-gray-300 text-[5px] sm:text-[6px] md:text-[9px] lg:text-[10px] mt-0.5 truncate">Premium dining area</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 md:gap-3 w-[32%] md:w-auto">
          ...
          <div className="flex flex-col overflow-hidden">
            ...
            <p className="text-gray-300 text-[5px] sm:text-[6px] md:text-[9px] lg:text-[10px] mt-0.5 truncate">Birthdays & Anniv.</p>
          </div>
        </div>
