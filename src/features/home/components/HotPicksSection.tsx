      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-5 lg:px-0">
        {data.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="bg-white rounded-xl lg:rounded-[1.25rem] border border-gray-100 shadow-[0_4px_15px_rgb(0,0,0,0.04)] overflow-hidden group hover:shadow-lg transition-all flex flex-col h-full"
            >
