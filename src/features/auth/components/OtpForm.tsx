          ...
          <div className="flex items-center justify-between gap-1 sm:gap-1.5">
            {otp.map((digit, index) => (
              <input
                ...
                className={`w-9 h-11 sm:w-11 sm:h-12 text-center text-lg font-bold text-[#1E2A22] bg-white rounded-xl border shadow-sm transition-all focus:outline-none focus:border-[#D9A441] focus:ring-4 focus:ring-[#D9A441]/10 ${
                  otpError
                    ? "border-red-500"
                    : "border-[#0F3D2E]/15"
                }`}
